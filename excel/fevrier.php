    ...
    <div class="row">
      <div class="col-lg-2">
        ...
        <ul class="list-group">
          ...
          <a href="fevrier.php"><li class="list-group-item list-group-item-action active">Février</li></a>
        ...
        <div class="col-lg-10 ">
             <table class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <td colspan="6" style="text-align: center;">MOIS <?=date('02'.'/Y') ?></td>
                    </tr>
                  <tr>
                    <th>DATE</th>
                    <th>N° PIÈCE</th>
          ...
          echo"<tbody>";
            ...
            $s2=0;
            $solde=0;
              $req=$connexion->query("SELECT DISTINCT depense.ref,depense.datee,depense.mtchiffre,depense.libelleop from relation inner join depense on depense.ref=relation.refdepense  where datee BETWEEN'2019-02-01' AND '2019-02-28'");
              $req1=$connexion->query("SELECT DISTINCT recette.ref_r,recette.datee_r,recette.mtchiffre_r,recette.libelleop_r from relationr inner join recette on recette.ref_r=relationr.refrecette WHERE datee_r BETWEEN'2019-02-01' AND '2019-02-28'");
