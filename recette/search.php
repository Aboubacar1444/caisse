...
<section class="content">
    <div class="row">
       <h1 class="soulign flex ">PIÈCE DE CAISSE - RÉCETTE</h1>
       <hr>
       <div class="col-xs-12">
		...
		<div class="box box-warning">
            <div class="box-header bg-info flex">
              <h3 class="box-title">GESTION - LISTE DES PIÈCES DE RÉCETTE ENRÉGISTRÉES</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
        <?php
					$reqs=$connexion->query("SELECT * from recette ORDER BY id DESC");
              ...
              $ref=$test['ref_r'];
              $datee=$test['datee_r'];
              $mtchiffre=$test['mtchiffre_r'];
              $lib=$test['libelleop_r'];
              $mtlettre=$test['mtlettre_r'];
              $signdirection=$test['signdirection_r'];
              $caisse=$test['caissier_r'];
              $benef=$test['benef_r'];
              echo "<td>".($ref)."</td>";
  						echo "<td>".($datee)."</td>";
