...
<body>
	<div class="container">
         ...
         <a href="novembre.php"> <li class="list-group-item list-group-item-action active">Novembre</li></a>
          <li class="list-group-item list-group-item-action"><a href="decembre.php">Décembre</a></li>
 			  ...
 			  <div class="col-lg-10">
                  ...
                  <thead>
                    <tr>
                      <td colspan="6" style="text-align: center;">MOIS <?=date('11'.'/Y') ?></td>
                    </tr>
                  <tr>
                    <th>DATE</th>
                    <th>N° PIÈCE</th>
          ...
          echo"<tbody>";
            ...
            $s2=0;
            $solde=0;
              $req=$connexion->query("SELECT DISTINCT depense.ref,depense.datee,depense.mtchiffre,depense.libelleop from relation inner join depense on depense.ref=relation.refdepense  where datee BETWEEN'2018-11-01' AND '2018-01-31'");
              $req1=$connexion->query("SELECT DISTINCT recette.ref_r,recette.datee_r,recette.mtchiffre_r,recette.libelleop_r from relationr inner join recette on recette.ref_r=relationr.refrecette Where datee_r BETWEEN'2018-11-01' AND '2018-11-31'");
