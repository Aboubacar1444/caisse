	...
	<div class="container">
 		...
 		<div class="row">
 			<!-- <div class="col-lg-2 noimp">
 				...
 				<hr>
 				<ul class="list-group">
          <a href="janvier.php"><li class="list-group-item list-group-item-action">Janvier</li></a>
          ...
          <a href="aout.php"><li class="list-group-item list-group-item-action active">Août</li></a>
          ...
          <li class="list-group-item list-group-item-action"><a href="decembre.php">Décembre</a></li>
 			  ...
 			  <div class="col-lg-10">
                  ...
                  <thead>
                    <tr>
                      <td colspan="6" style="text-align: center;">BILAN ANNUEL</td>
                    </tr>
                  <tr>
                    <th>DATE</th>
                    <th>N° PIÈCE</th>
          ...
          echo"<tbody>";
            ...
            $s2=0;
            $solde=0;
              $req=$connexion->query("SELECT DISTINCT depense.ref,depense.datee,depense.mtchiffre,depense.libelleop from relation inner join depense on depense.ref=relation.refdepense ORDER BY datee ASC");
              $req1=$connexion->query("SELECT DISTINCT recette.ref_r,recette.datee_r,recette.mtchiffre_r,recette.libelleop_r from relationr inner join recette on recette.ref_r=relationr.refrecette ORDER BY datee_r ASC");
