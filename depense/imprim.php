	...
	<div class="row">
			<table class="table">
				<tr>
					...
					<br><h6>Pièce N°... : <?php echo $ref; ?></h6></div></td>
					<td><div class="col-lg-6">
					<br><h6> Date : <?php echo $date; ?></h6></div></td>
				</tr>
		...
		<div class="row">
  		...
  		<div class="row flex">
  			<div class="col-lg-6 noimp">
  				<button class="btn btn-outline-warning" onclick="window.print()" name="imprimer">Imprimer</button>
  			</div>
  			<div class="col-lg-6 noimp">
  				<button onclick="window.location.href='../index.php'" class="form-group btn btn-outline-info">Retournez à l'accueil</button> 
  			</div>
  		</div>
  	</div>
<hr class="noimp">
